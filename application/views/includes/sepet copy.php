<div class="wrapp-minicart">
    <div class="minicart-padding">
        <div class="number-item">Sepetinde <span><?php //echo sepet_say($user_id); ?></span> ürün var</div>
                    ...
                    <div class="detail-item">
                        <div class="product-details">
                            ...
                            <div class="product-action clearfix">
                                <a href="<?php echo base_url("sepet-sil/$product_box->id/"); ?>" rel="nofollow" class="btn-remove" title="Sepetten Çıkar"><span class="fa fa-trash-o"></span></a>           
        ...
        <div class="cart-checkout">
            ...
            <div class="cart-links clearfix">
                <div class="cart-link"><a href="<?php echo base_url("sepet"); ?>/" title="Sepet">Sepeti Gör</a></div>
                <div class="checkout-link"><a href="<?php echo base_url("odeme"); ?>/" title="Ödeme">Alışverişi Tamamla</a></div>
            </div>
        </div>
    </div>
</div>